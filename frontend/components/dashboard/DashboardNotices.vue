  ...
  <UiCard>
    <UiCardHeader class="pb-3">
      <div class="flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4 text-red-500" aria-hidden="true">
          <path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" /><line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" />
        </svg>
        <UiCardTitle class="text-base">{{ $t('dashboard.notices.title') }}</UiCardTitle>
      </div>
    </UiCardHeader>
    <UiCardContent>
      ...
      <div v-else class="space-y-1">
        ...
        >
          <UiBadge v-if="n.is_must_read" variant="destructive" class="text-[10px] py-0 shrink-0 mt-0.5">{{ $t('common.mustRead') }}</UiBadge>
