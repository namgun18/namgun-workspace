  ...
  <div class="border rounded-lg overflow-hidden">
    ...
    <table v-else class="w-full text-sm">
      <thead class="bg-muted/30">
        <tr class="border-b">
          <th class="text-left px-4 py-2.5 font-medium w-full">제목</th>
          <th class="text-left px-3 py-2.5 font-medium whitespace-nowrap hidden sm:table-cell">작성자</th>
          <th class="text-center px-3 py-2.5 font-medium whitespace-nowrap hidden md:table-cell">조회</th>
          <th class="text-center px-3 py-2.5 font-medium whitespace-nowrap hidden md:table-cell">댓글</th>
          <th class="text-right px-4 py-2.5 font-medium whitespace-nowrap hidden sm:table-cell">일시</th>
        </tr>
      </thead>
      <tbody>
        <!-- Pinned posts -->
        ...
        >
          <td class="px-4 py-2.5">
            <div class="flex items-center gap-1.5">
              <UiBadge variant="secondary" class="text-[10px] shrink-0 py-0">공지</UiBadge>
              <UiBadge v-if="post.is_must_read" variant="destructive" class="text-[10px] shrink-0 py-0">필독</UiBadge>
              ...
              <span v-if="post.has_attachments" class="text-muted-foreground shrink-0" title="첨부파일">
